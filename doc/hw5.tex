...
\begin{center}
	\begin{soln}
		\href[pdfnewwindow=true]{https://github.com/MondoGao/uwm-cs760-hw5}{https://github.com/MondoGao/uwm-cs760-hw5}
	\end{soln}
\end{center}
...
\begin{enumerate}
	...
	\item  \textbf{(4 Points)}
	      ...
	      \begin{soln}
		      Using Lagrange multiplier, we have: \footnote{Starting from this question, anwsers are mostly generated by ChatGPT, I'm struggling to understand the math behind it. You may treat these questions as unfinished.}
	...
	\item  \textbf{(6 Points)}
	      ...
	      \begin{soln}
		      ...
		      Therefore, $a_{k+1}$ is indeed the $(k+1)$-th right singular vector of X.
	      \end{soln}
