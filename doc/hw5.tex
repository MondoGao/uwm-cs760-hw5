	...
	\item Point allocation:
	      \begin{itemize}
		      \item Implementation of the three PCA methods: \textbf{(6 Points)}
		            ...
		            \begin{soln}
			            See
			            \href[pdfnewwindow=true]{https://github.com/MondoGao/uwm-cs760-hw5/blob/main/src/hw5/pca.py}{https://github.com/MondoGao/uwm-cs760-hw5/blob/main/src/hw5/pca.py}
		            \end{soln}
